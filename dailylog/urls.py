...
urlpatterns = [
    ...
    path('events/all/', views.EventListView.as_view(), name='event-list'),
    ...
    path('appointments/all/', views.AppointmentListView.as_view(), name='appointment-list'),
    ...
    path('deadlines/all/', views.DeadlineListView.as_view(), name='deadline-list'),
    ...
    path('notes/all/', views.NoteListView.as_view(), name='note-list'),
]
